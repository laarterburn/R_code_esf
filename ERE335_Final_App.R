...
ui <- fluidPage(theme = bs_theme(version = 4, bootswatch = "minty"),
                navbarPage(
                    "",
                    tabPanel("Introduction", radioButtons("state", label = HTML('<FONT color="black"><FONT size="5pt">AQI Index Information for the Top Nine Vacation Destinations in the United States</FONT></FONT><br> <b>A website to educate and inform the public on the AQI index in vacation destinations and how it may impact people 
</b>'),
                                                          choices = list(),
                                                          selected = 1,
                                                          inline = T,
                ...
                tabPanel("What is AQI?",tags$strong("What is AQI?"), tags$p("AQI is the air quality index that is used in the USA to track various pollutants. This website will display the data for the following pollutants:
                                                                            Carbon Monoxide,
                                                                            Nitric Oxide,
                                                                            Ozone,
                                                                            PM 2.5,
                                                                            PM 10, and
                                                                            Sulfur Dioxide
                                                                            This index tells you the quality of the air outdoors. It ranges from 0 to 500, lower numbers being better air quality and higher numbers being worse, as you can see by the table below. "),img(src="rstudioaqi") )
                ,tabPanel("Health Impacts", tags$strong("Health Impacts")),
                         tabPanel("Pollutants", tags$strong("Pollutants")),
                navbarMenu("Location",
                           tabPanel("NYC", tags$summary("hi")),
                           tabPanel("Miami"),
